# Clone-this-homepage prompt

Copy the block below and paste it to your colleague. It's a self-contained brief
for Claude (or any capable coding agent) to scaffold a personal academic
homepage modeled on https://fabsilvestri.github.io/.

---

Hi Claude — I want you to build me a personal academic homepage modeled on my
colleague Fabrizio Silvestri's:
